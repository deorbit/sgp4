...
int main()
{
    ...
    Tle npp_tle = Tle("SUOMI NPP               ",
                      "1 37849U 11061A   14041.12046687  .00000090  00000-0  63671-4 0  6975",
                      "2 37849  98.7788 342.1424 0001698  89.4368  26.8830 14.19529645118566");

    SGP4 sgp4(npp_tle);

    std::cout << npp_tle << std::endl;
